...
const ContactSection: React.FC = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      title: "Call Us",
      info: "+254 XXX XXX XXX",
      action: "tel:+254XXXXXXX"
    },
    {
      icon: MapPin,
      title: "Visit Us",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-muted-foreground">
            Ready to make a difference? Connect with us to learn how you can contribute to 
            Kenya's sustainable future.
          </p>
        </div>
        ...
        <div className="mb-16">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.815196997524!2d36.8193251!3d-1.2921!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMcKwMTcnMzEuNiJTIDM2wrA0OScxOC44IkU!5e0!3m2!1sen!2sus!4v1677654321"
            width="100%"
            height="270"
            style={{ border: 0 }}
            allowFullScreen
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="eco-card bg-gradient-to-br from-primary/5 to-accent/5 border-primary/20">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">Local vendors and distributors</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="h-4 w-4 text-primary" />
                  <span className="text-sm">Environmental organizations</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="h-4 w-4 text-primary" />
                ...
                <div className="flex items-center gap-2">
                  <CheckCircle className="h-4 w-4 text-primary" />
                  <span className="text-sm">Hotels and restaurants</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="h-4 w-4 text-primary" />
            ...
            <div className="eco-card bg-gradient-to-br from-accent/5 to-eco-blue/5 border-accent/20">
              ...
              <p className="text-muted-foreground">
                Join a movement that's not just about business, but about creating lasting 
                positive change for Kenya's environment and communities. Together, we can 
                build a sustainable future that benefits everyone.
              </p>
            </div>
          </div>
        </div>
